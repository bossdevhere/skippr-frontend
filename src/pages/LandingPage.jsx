    ...
    <div className="min-h-screen bg-background text-foreground selection:bg-emerald-500/30 overflow-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden">
        <motion.div 
          ...
          className="absolute -top-[10%] -left-[5%] w-[60%] h-[60%] bg-emerald-500/[0.08] blur-[100px] rounded-full" 
        />
        <motion.div 
          animate={{ 
            scale: [1.1, 1, 1.1],
          ...
          className="absolute -bottom-[10%] -right-[5%] w-[50%] h-[50%] bg-blue-500/[0.08] blur-[100px] rounded-full" 
        />
      </div>
      ...
      >
        <div className="max-w-7xl mx-auto text-center space-y-12">
          ...
          >
            <Button 
              size="lg" 
              className="h-16 px-12 text-lg font-black group rounded-2xl bg-emerald-500 hover:bg-emerald-600 text-white shadow-[0_20px_40px_-15px_rgba(16,185,129,0.3)]" 
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {features.map((feature, i) => (
              ...
              >
                <div className={cn(
                  "h-14 w-14 rounded-2xl flex items-center justify-center mb-8 shadow-xl transition-transform group-hover:scale-110 group-hover:rotate-3",
                  feature.color
                )}>
